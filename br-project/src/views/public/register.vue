           ...
           <div class="login-title">— 注册 —</div>
             <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position="left" label-width="0px" class="demo-ruleForm login-container">
              ...
              <el-form-item prop="account">
                ...
                <el-input type="text" class="write-input" v-model="ruleForm.checphone" auto-complete="off" placeholder="手机号">
                    
                </el-input>
              </el-form-item>
              <el-form-item prop="account">
                  <i class="login_check_dot"></i>
                  <el-button style="margin-top: 12px;" class="getcode"  :disabled="control" @click="handlegetcode">{{viewget}}</el-button>
                <el-input type="text" class="write-input" v-model="ruleForm.checkcode" auto-complete="off" placeholder="手机验证码">
              ...
              <el-form-item style="width:100%;">
                <el-button type="primary" style="width:100%; height:50px;color: #fff;border:none;background:#39B690;" class="login-btn" @click.native.prevent="handleSubmit2" :loading="logining">注册</el-button>
...
<script>
  import { getCode , register} from '../../api/api';
    ...
    export default {
        ...
        computed:{
            dialogTableVisible(){
                return this.$store.state.registerview;
            }
       },
        methods:{
            tologin(){
